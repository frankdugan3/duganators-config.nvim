...
require('conform').setup {
  ...
  formatters_by_ft = {
    ...
    json = { 'ast-grep', 'prettierd', 'prettier' },
    typescript = { 'ast-grep', 'prettierd', 'prettier' },
    markdown = { 'ast-grep', 'prettierd', 'prettier' },
    html = { 'ast-grep', 'prettierd', 'prettier' },
    css = { 'ast-grep', 'prettierd', 'prettier' },
    shtml = { 'superhtml' },
    ziggy = { 'ziggy' },
...
set('n', '<leader>nc', function()
  vim.cmd.edit(vim.fn.stdpath 'config' .. '/lua/colorscheme.lua')
